...
namespace FlatUI
{
	...
	public class FlatTrackBar : Control
	{
		...
		private Color _TrackColor = Color.FromArgb(23, 148, 92);
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			_with20.FillRectangle(new SolidBrush(_HatchColor), new Rectangle(0, 7, Track.X + Track.Width, 8));
			_with20.ResetClip();

			//-- Hatch Brush
			HatchBrush HB = new HatchBrush(HatchStyle.Plaid, HatchColor, _HatchColor);
